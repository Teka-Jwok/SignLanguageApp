...
function aboutus(){
	...
	document.getElementById("AboutUs").innerHTML= "We are a group of four students who share a single common goal; to bridge the gap between deaf and hearing family members and friends. We believe that our world is a better when people can freely communicate with each other. We hope that the users of this application can use it to continue to allow deaf people around the world to share their thoughts and ideas with the community. Yours Truly, The YSLH Team."
